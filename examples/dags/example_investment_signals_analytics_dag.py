...
config = Config(
    dbt_project=DbtProjectConfig(
        dbt_project_name='investment_signals_analytics',
        dbt_project_path='/opt/airflow/dags',
        dbt_models_path='/opt/airflow/dags/investment_signals_analytics/dbt/models',
        dbt_profiles_path='/opt/airflow/dags',
        dbt_target_path='/opt/airflow/dags/target',
        dbt_log_path='/opt/airflow/dags/logs',
        dbt_schema='investment_signals',
    ),
...
dags = compile_dbt_af_dags(
    ...
    config=config,
    etl_service_name='investment_signals',
)
